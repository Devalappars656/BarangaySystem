...
<table class="Table1">
	<tr>
		...
		<td>
			<input type="number" name="Age" placeholder="Age" style="width: 50px;">
		</td>
		<td>
			<input type="number" name="Zone" placeholder="Zone" style="width: 50px;">
		</td>
		...
		<td>
			<input type="number" name="Age2" placeholder="Age" style="width: 50px;">
		</td>
		<td>
			<input type="number" name="Zone2" placeholder="Zone" style="width: 50px;">
		</td>
