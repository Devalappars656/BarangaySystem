...
$sql=mysqli_query($dbconnect, "insert into ResidentInfo(LastName,FirstName,MiddleName,Gender,BirthDate,BirthPlace,CivilStatus,Zone,DateRegistered,PhoneNumber,EmailAddress) values('$LastName','$FirstName','$MiddleName','$Gender','$BirthDate','$BirthPlace','$CivilStatus','$Zone','$DateRegistered','$PhoneNumber','$EmailAddress')");

	echo "<h3 class='Success'>SUCCESSFUL REGISTERED<h3/>";
}
